...
@echo.
@echo		"만일을 위해서 현재 자신의 규칙을 백업을 하세요."
@echo   "백업 파일 위치는 윈도키 + R %temp%"
@echo   "advfirewall_file.wfw"
@echo.
@echo		"다른 추가 새로운 규칙을 적용 하려면 필히 기존 규칙 제거를 하고 실행 하세요"
@echo.
...
color 07
REM "최종 목적지 배치 파일 종료"
REM "https://cafe.daum.net/candan/BLQD/89"
echo.
